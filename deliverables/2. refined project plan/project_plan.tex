...
\clearpage
\pagenumbering{Roman} % Große römische Zahlen (I, II, III) für Inhaltsverzeichnis

\tableofcontents 
\clearpage      

\pagenumbering{arabic} % Normale Zahlen (1, 2, 3) ab dem Hauptteil
...
\subsection{Additional helpful literature}
...
Table~\ref{tab:project_timeline} below shows the first export of our current tickets. The export was done on March 28, 2026. 
...
\clearpage
\pagenumbering{roman} % Kleine römische Zahlen (i, ii, iii) für die Verzeichnisse
