...
Figure~\ref{fig:beam} presents the BEAM representation \cite{wu2023beam} of the proposed tree detection system, illustrating the data sources, training and inference processes, model architecture, evaluation pipeline, and associated risks.
