...
The figure below presents the BEAM representation \cite{wu2023beam} of the proposed tree detection system (see Figure 2), illustrating the data sources, training and inference processes, model architecture, evaluation pipeline, and associated risks.
