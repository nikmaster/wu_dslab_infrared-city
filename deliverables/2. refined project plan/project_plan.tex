...
\begin{enumerate}
    ...
    \item \textbf{Communication with Data Coaches from infrared.city}: No regular meeting is scheduled with the data coaches. Instead we write weekly reports in the shared Teams channel.
\end{enumerate}
