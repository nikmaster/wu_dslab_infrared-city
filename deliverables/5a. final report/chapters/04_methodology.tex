\section{Methodology}
For this tree detection task we implemented a \textit{U-Net} regression architecture with a temporal attention mask which predicts the number of trees per pixel of \textit{Sentinel-2} data where the prediction labels are derived from communal tree registers. 

\subsection{Data Processing}

The first methodological step was fetching the different datasets on Sentinel-2 images, tree locations and OSM information. Figure~\ref{fig:overview_beam} shows an overview of the Data Processing.
